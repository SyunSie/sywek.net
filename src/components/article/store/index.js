    ...
    sections: [
        ...
        contentElements: [
          {
            ...
            content: { text: "Section 0-0 text content." },
            jumpLines: 0,
            navId: "st01",
          },
          {
            contentType: "header",
            content: { text: "Section <br>0-1 text content." },
            jumpLines: 0,
            navId: "st01h02",
          },
          {
            contentType: "text",
            content: { text: "Section 0-2 text content." },
            jumpLines: 0,
          },
          {
            contentType: "image",
      ...
      },
      {
        contentElements: [
          {
            contentType: "subTitle",
            content: { text: "Section 1-0 text content." },
            jumpLines: 0,
            navId: "st02",
          },
          {
            contentType: "header",
            content: { text: "Section 1-1 text content." },
            jumpLines: 0,
            navId: "st02h02",
          },
          {
...
const getters = {
  ...
  getArticleNavInfo() {
    /*
    {
      ...
      let articleNavInfo = {subTitleNav}:[]};

      //let findPreverse

      state.article.sections.forEach(s => {
        let sectionNavInfo = {sectionHeader:'',}
...
const mutations = {
  ...
  udpateNav(state) {
    ...
    let st = 0;
    let h = 0;
    let findSTinCurrentSection = false;
